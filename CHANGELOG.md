...
First beta of the 1.0 line. The headline work since 0.9.7 is the **tenant data isolation audit** that hardens every backend data-access path before the 1.0 stable cut, plus two infrastructure features that landed on the way there: scheduled email digests and end-to-end request-context propagation.
